...
<model ref="r:8df613ce-1aa6-4e8b-b0ce-d514b7032ee4(ca.uwaterloo.gsd.ros.refactorings)">
  ...
  <node concept="3SMa$L" id="18Q9s9Clt71">
    <property role="TrG5h" value="Template_Update" />
    <property role="3SMaAB" value="Update Templates" />
    <node concept="3ZiDMR" id="18Q9s9Clt73" role="3SMaAD">
      <node concept="3clFbS" id="18Q9s9Clt74" role="2VODD2" />
    </node>
    <node concept="3SM$So" id="18Q9s9Cltm4" role="3SM$Oy">
      <ref role="3SM$Vy" to="smma:bl22kSm_0N" resolve="Message" />
    </node>
  </node>
</model>
