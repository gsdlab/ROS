...
<model ref="r:93a2b078-ef83-42b0-b029-1945c813f5b6(ca.uwaterloo.gsd.ros.plugin.plugin)">
  ...
  <imports>
    ...
    <import index="ex85" ref="r:8df613ce-1aa6-4e8b-b0ce-d514b7032ee4(ca.uwaterloo.gsd.ros.refactorings)" />
  ...
  <node concept="33ghlw" id="6JV68EXEnSM">
    ...
    <node concept="33gmoH" id="6JV68EXEnSN" role="2hfSGL">
      ...
      <ref role="33glcY" to="gx6f:6JV68EXDDBt" resolve="byteSize" />
    </node>
    <node concept="tT9cl" id="6JV68EXEnSO" role="2hfP89">
